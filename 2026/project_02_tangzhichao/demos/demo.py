...
TEST_DIR = Path(__file__).resolve().parent.parent / "data/test_examples/advanced"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "results/demo"
CHECKPOINT_CANDIDATES = [
    str(Path(__file__).resolve().parent.parent / "outputs/best_model.pth"),
